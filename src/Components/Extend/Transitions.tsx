...
type TypePosition = 'top-left' | 'top-right' | 'top' | 'bottom-left' | 'bottom-right' | 'bottom';
type TypeType = 'grow' | 'fade' | 'collapse' | 'slide' | 'zoom';
...
export const Transitions = ({ children, position = 'top-left', type = 'grow', direction = 'up', ...others }: TypeTransitions) => {
